...
--
-- Host: 127.0.0.1
-- Generation Time: 25-Fev-2019 às 16:59
...
INSERT INTO `cliente` (`id`, `cpf_ou_cnpj`, `email`, `nome`, `tipo_cliente`) VALUES
(1, '32341566', 'maria@gmail.com', 'Marria Silva', 1);
...
(1, 'Jardim', '5523123331', 'Apto 303', 'Rua Flores', '300', 1, 1),
(2, 'Centro', '3877012', 'Sala 800', 'Avenida Matos', '105', 2, 1);
...
INSERT INTO `pedido` (`id`, `instate`, `cliente_id`, `endereco_entrega`) VALUES
(1, '2017-09-30 13:32:00', 1, 1),
(2, '2017-10-10 13:32:00', 1, 2);
...
ALTER TABLE `pedido`
  ...
  ADD KEY `FK5hwxs71cxf3c75ck3oj1peurv` (`endereco_entrega`);
